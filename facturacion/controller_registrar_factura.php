...
// Incluir archivo con funciones para convertir números a letras
include('literal.php');
...
$dia = date("d");
$mes = date('m');
// Convertir el número de mes a su nombre correspondiente
if($mes=="1")$mes = "Enero";
...
// Obtener los datos de la factura de la URL
...
// Obtener otros datos de la factura de la URL
...
echo'Factura exitosa: el total es: ', $precio_final = $precio_dia + $precio_hora;
...
if($sentencia->execute()){
    echo 'success';
        ...
        // Actualizar el estado del espacio en el mapeo
    ...
    // Actualizar el estado del espacio en los tickets
