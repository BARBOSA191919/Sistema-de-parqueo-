<?php
// Incluir archivos de configuración y de datos de sesión del usuario
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <?php
                             // Obtener el ID del precio desde la URL
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="" id="detalle" class="form-control">
                                            <?php
                                            // Mostrar opciones dependiendo del detalle actual del precio
                                            if($detalle == "HORAS"){ ?>
