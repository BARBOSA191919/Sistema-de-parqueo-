<?php
// Incluye los archivos de configuración y de datos de usuario de sesión
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <h2>Listado de precios</h2> <!-- Título de la página -->
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <table id="table_id" class="table table-bordered table-sm table-striped">
                                ...
                                <tbody>
                                <?php
                    // Consulta a la base de datos para obtener los precios
                                ...
                                foreach($datos_precios as $datos_precio){
                                 // Recorre los resultados y muestra cada precio en la tabla
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                <!-- Botón de edición para cada precio -->
                    ...
                    <hr>
                                            <!-- Icono para el botón de generar reporte -->
