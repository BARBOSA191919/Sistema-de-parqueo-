<?php
// Incluir archivo de configuración y datos de sesión de usuario
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                           ...
                           <div class="row">
                            ...
                            <script>
                            // Evento click del botón registrar precio
                                $('#btn_registrar_precio').click(function () {
                                 ...
                                 // Si los campos están llenos, hacer la solicitud al controlador para registrar el precio
