...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/principal.php" class="brand-link">
        <img src="<?php echo $URL;?>/public/imagenes/auto1.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">Neiva York</span>
    </a>

    <!-- Barra lateral -->
    <div class="sidebar">
        <!-- Barra lateral user  (optional) -->
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- ADMINISTRADOR O CONTADOR SE ESCOGE, SE AGREGA O ELIMNA  -->
                ...
                <!-- SE GENERA UN FACTURA DE REPORTE DE CADA SITUACION DEL SISTEMA DE PARQUEO EN CADA UNA -->
