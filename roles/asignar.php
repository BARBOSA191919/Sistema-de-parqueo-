...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
        <!-- Tarjeta para mostrar el listado de usuarios -->

                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Listado de usuario</h3>
                                <div class="card-tools">
                            <!-- Botón para colapsar/expandir la tarjeta -->
                            ...
                            <!-- Ciclo para recorrer y mostrar los usuarios -->
                                    <?php
                                    $contador = 0;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <?php
                                                    if($rol == ""){ ?>
                                                        <!-- Botón para asignar un rol (abrir modal) -->
