<?php
// Incluir el archivo de configuración y los datos de sesión del usuario
...
<div class="wrapper">
        ...
        <div class="container">
            ...
            <script>
                $(document).ready(function() {
                        // Configurar el plugin DataTable para la tabla
                    $('#table_id').DataTable( {
                        "pageLength": 5,
                        "language": {
            ...
            <!--tarjetas y selecciona base de datos para asignar -->                    
            <div class="row">
                <div class="col-md-6">
    ...
    <!-- incluye el admin adecuado y footer -->
