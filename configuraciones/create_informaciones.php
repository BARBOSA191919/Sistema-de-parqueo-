...
<div class="wrapper">
    <?php include('../layout/admin/menu.php'); ?> <!-- Se incluye el menú de la aplicación -->
    ...
    <!-- /.content-wrapper -->
    <?php include('../layout/admin/footer.php'); ?> <!-- Se incluye el pie de página -->
</div>
<?php include('../layout/admin/footer_link.php'); ?> <!-- Se incluyen los enlaces JavaScript -->
</body>
</html>

<!-- Script para manejar el registro de la información -->
<script>
    $('#btn_registrar_informacion').click(function () {
       ...
       var pais = $('#pais').val();
        ...
        if(nombre_parqueo == ""){
            ...
            // Si todos los campos están llenos, se envían los datos al controlador
