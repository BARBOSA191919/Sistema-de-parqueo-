...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <br>
                        <!--Configuración de DataTables para la tabla de usuarios-->
            ...
            <table id="table_id" class="table table-bordered table-sm table-striped">
                ...
                foreach($usuarios as $usuario){
                    ...
                    // Iteración sobre los usuarios obtenidos para mostrar en la tabla
                    $id = $usuario['id'];
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                        <!-- Botones para editar y borrar usuarios -->
