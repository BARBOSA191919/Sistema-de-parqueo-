...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <!--Invocamos la base de datos de los usuarios para poder eliminar -->
            ...
            <!--Creamos el formulario si desea eliminarlos -->
    ...
    <!-- enlaces de admin y footer adecuados -->
...
<script>
    // Función que se ejecuta al hacer clic en el botón Borrar
    $('#btn_borrar').click(function () {

            // obetenemos el id
        var id_user = '<?php echo $id_get = $_GET['id'];?>';

        var url = 'controller_delete.php'; // Define la URL del controlador PHP encargado de eliminar el usuario
        $.get(url,{id_user:id_user},function (datos) { // Realiza una petición GET al controlador PHP enviando el ID
