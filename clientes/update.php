<?php
// Se incluyen los archivos de configuración y datos de usuario de sesión
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <?php
                        // Se obtienen los datos del cliente mediante su ID
    ...
    $('#btn_actualizar_cliente').click(function () {
        ...
        if(nombre_cliente == ""){
            ...
            var url = 'controller_update.php';
                // Se realiza una petición GET para actualizar los datos del cliente
